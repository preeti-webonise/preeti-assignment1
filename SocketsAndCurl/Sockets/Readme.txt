...
Connection:-
-----------------------------------------------------------------
1. Connection will include Details of host and port which will be used for socket creation and connection.
This file is included in server.php and client.php
...
-----------------------------------------------------------------
1. Place the Input.html,client.php,server.php and socketConnection.php in the /var/www/html folder or the default localhost directory.
2. Navigate to server.php through url in browser.
3. In a new tab Navigate to Input.html for the UI.
